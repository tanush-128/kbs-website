    ...
    <div className="max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mt-44">
      ...
      <div className="grid sm:grid-cols-12 gap-6">
        <div className="sm:self-end col-span-12 sm:col-span-7 md:col-span-8 lg:col-span-5 lg:col-start-3">
          <a
            className="group relative block rounded-xl overflow-hidden focus:outline-none focus:ring-1 focus:ring-gray-600"
          ...
          >
            ...
            <div className="absolute bottom-0 start-0 end-0 p-2 sm:p-4">
              <div className="text-sm font-bold text-gray-200 rounded-lg  p-4 md:text-xl bg-gray-800">
                Hands-On Learning
              </div>
            </div>
          </a>
