const SignUp = () => {
    return (
        ...
        before:bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element-dark.svg')]">
            <body class="flex h-full items-center py-16">
                        ...
                        <div class="p-4 sm:p-7">
                            <div class="text-center">
                                ...
                                <p class="mt-2 text-sm text-gray-400">
                                    ...
                                    <a class="text-green-600 decoration-2 hover:underline font-medium focus:outline-none focus:ring-1 focus:ring-gray-600" href="/signin">
                                        Sign in here
                                    </a>
                                </p>
                            </div>
