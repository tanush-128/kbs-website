            ...
            <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
                <div className="mt-20 max-w-3xl text-center mx-auto">
                    <h1 className="block font-bold text-6xl md:text-5xl lg:text-8xl text-gray-100">
                        Kharagpur <br />
                        <span className="bg-clip-text bg-gradient-to-tl from-green-800 to-green-400 text-transparent">
                            Blockchain
                        </span>
                        <br />
                        Society
                ...
                <div className="mt-5 max-w-3xl text-center mx-auto">
                    <p className="text-lg text-gray-400 ">GM Everyone!</p>
                </div>

                <div className="gap-3 flex justify-center">
                    <div className="mt-4 sm:mt-5 flex justify-center flex-wrap">
                        <a className="m-1 py-3 px-4 inline-flex items-center gap-x-2 text-sm rounded-lg border border-gray-700  shadow-sm hover:bg-gray-800 disabled:opacity-50 disabled:pointer-events-none bg-slate-900 text-white focus:outline-none focus:ring-1 focus:ring-gray-600" href="#">
