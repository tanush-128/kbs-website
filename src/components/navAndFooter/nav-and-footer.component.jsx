        ...
        <Fragment>
                ...
                <nav className="mt-6 relative max-w-[85rem] w-full bg-gray-800  border border-gray-700 bg-opacity-80 rounded-[36px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto" aria-label="Global">
                    ...
                    <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
                        <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7">
                            ...
                            {userEmail ? (
                            <>      
                                <p classNameName="font-medium text-gray-400  md:py-6 hover:text-gray-500">{userEmail}</p>
            ...
            <footer className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
                <div className="text-center">
                    <div>
                        <button className="flex-none text-xl font-semibold text-white focus:outline-none focus:ring-1 focus:ring-gray-600" onClick={redirectToHome} aria-label="Brand">Kharagpur Blockchain Society</button>
                    </div>


                    <div className="mt-3">
                        <p className="text-gray-500">Made with ❤️ by Kharagpur Blockchain Society</p>
                    </div>

                    <div className="mt-3 space-x-2">
                        <a className="inline-flex justify-center items-center w-10 h-10 text-center rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition text-gray-500 hover:text-gray-200 hover:bg-gray-800" href="#">
