            ...
            <header class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm fixed top-0">
                <nav class="mt-6 relative max-w-[85rem] w-full bg-gray-800  border border-gray-700 bg-opacity-80 rounded-[36px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto" aria-label="Global">
                    <div class="flex items-center justify-between">
                        <a class="flex-none text-xl font-bold text-white" href="/" aria-label="Brand">K<span class="bg-clip-text bg-gradient-to-tl from-green-800 to-green-400 text-transparent">B</span>S</a>
                        <div class="md:hidden">
                    ...
                    <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
                        <div class="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7">
                            ...
                            <a class="font-medium text-gray-400  md:py-6 hover:text-gray-500" href="#">
                                About
                            </a>
                            <a class="font-medium text-gray-400  md:py-6 hover:text-gray-500" href="/events">
                                Events
                            </a>
                            <a class="font-medium text-gray-400  md:py-6 hover:text-gray-500" href="/blogs">
                                Blogs
                            </a>
                            <a class="font-medium text-gray-400  md:py-6 hover:text-gray-500" href="/team">
                                Team
                            </a>

                            <a class="flex items-center gap-x-2 font-medium text-gray-400 hover:text-green-700 md:border-s md:border-gray-300 md:my-6 md:ps-6 hover:text-green-500" href="/signin">
                ...
                <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                        <div class="col-span-full lg:col-span-1">
                            <a class="flex-none text-xl font-bold text-white text-center" href="/" aria-label="Brand">Kharagpur<br /><span class="bg-clip-text bg-gradient-to-tl from-green-800 to-green-400 text-transparent">Blockchain<br /></span>Society</a>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="mt-3 grid space-y-3">
                                <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-none focus:ring-1 focus:ring-gray-600" href="#">Pricing</a></p>
                                <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-none focus:ring-1 focus:ring-gray-600" href="#">Changelog</a></p>
                                <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-none focus:ring-1 focus:ring-gray-600" href="#">Docs</a></p>
                            </div>
                        </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <form>
                                <div class="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 rounded-lg p-2 bg-gray-800">
                                    <div class="w-full">
                                        <label for="hero-input" class="sr-only">Search</label>
                                        <input type="text" id="hero-input" name="hero-input" class="py-3 px-4 block w-full border-transparent rounded-lg text-sm focus:border-green-500  disabled:opacity-50 disabled:pointer-events-none bg-slate-900 text-gray-400 focus:ring-gray-600" placeholder="Enter your email" />
                                    </div>
