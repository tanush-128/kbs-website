    ...
    return (
        <div class="max-w-6xl py-10 px-4 sm:px-6 lg:px-8 lg:py-16 mx-auto">
          <div class="max-w-xl text-center mx-auto">
            <div class="mb-5">
              <h2 class="text-2xl font-bold md:text-3xl md:leading-tight dark:text-white">Finally, the<span class='mx-3 font-mono font-medium text-green-400'>{InputString}</span>at the bottom of every single landing page!</h2>
            </div>
