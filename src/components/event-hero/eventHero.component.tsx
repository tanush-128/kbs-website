const EventHero = () => {
    return (
        ...
        before:bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element-dark.svg')]" >
            <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8  sm:pt-24 sm:pb-10">
            ...
            <div className="max-w-6xl px-4 sm:px-6 lg:px-8  mx-auto sm:pb-10 mb-10">
                <div className="max-w-xl text-center mx-auto">
                    <div className="mb-5">
                        <h2 className="text-2xl font-bold md:text-3xl md:leading-tight text-white">Don't want to miss the next event? <br />
                    ...
                    <form>
                        <div className="mt-5 lg:mt-8 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
                            <div className="w-full">
                                ...
                                <input type="email" id="hero-input" name="hero-input" className="py-3 px-4 block w-full  rounded-lg text-sm focus:border-green-500 focus:ring-green-500 disabled:opacity-50 disabled:pointer-events-none bg-slate-900 border-gray-700 text-gray-400 focus:ring-gray-600" placeholder="Enter your email"/>
                            </div>
