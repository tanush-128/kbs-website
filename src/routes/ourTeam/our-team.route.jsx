        ...
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto lg:mt-20">
            ...
            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                ...
                <p class="mt-1 text-gray-600 dark:text-gray-400">
                    The Team behind Kharagpur Blockchain Society
                </p>
            </div>
                ...
                <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4">
                    ...
                    <div class="sm:flex sm:flex-col sm:h-full">
                        ...
                        <div class="mt-2 sm:mt-auto space-x-2.5">
                            <a class="inline-flex justify-center items-center text-gray-500 rounded-full hover:text-gray-800 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
