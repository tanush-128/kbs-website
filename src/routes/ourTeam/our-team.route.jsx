const OurTeam = () => {
    return (
        ...
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto lg:mt-20">

            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                <h2 class="text-2xl font-bold md:text-4xl md:leading-tight text-white">Our Team</h2>
                <p class="mt-1 text-gray-400">Creative people</p>
            </div>
                ...
                <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4">
                    ...
                    <div class="sm:flex sm:flex-col sm:h-full">
                        ...
                        <div class="mt-2 sm:mt-auto space-x-2.5">
                            <a class="inline-flex justify-center items-center text-gray-500 rounded-full hover:text-gray-200  focus:outline-none focus:ring-1 focus:ring-gray-600" href="#">
                            ...
                            <a class="inline-flex justify-center items-center text-gray-500 rounded-fullhover:text-gray-200 focus:outline-none focus:ring-1 focus:ring-gray-600" href="#">
                                <svg class="flex-shrink-0 w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
